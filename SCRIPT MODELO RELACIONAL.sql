...
/*  Created On : 01-dic.-2020 9:48:24 a. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	f_fechaHoraInicio timestamp without time zone NOT NULL,	-- Fecha y hora de la entrada del vehiculo
	f_fechaHoraSalida timestamp without time zone NULL,	-- Fecha y hora de salida del vehiculo
	k_slot integer NULL,
	k_vehiculo varchar(6) NULL
)
;
