...
/*  Created On : 24-feb.-2021 2:18:00 p. m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE Contrato ADD CONSTRAINT FK_Contrato_Cliente
	FOREIGN KEY (k_cliente) REFERENCES  () ON DELETE No Action ON UPDATE No Action
;
...
ALTER TABLE Servicio ADD CONSTRAINT FK_Servicio_Vehiculo
	FOREIGN KEY (k_vehiculo) REFERENCES  () ON DELETE No Action ON UPDATE No Action
;
