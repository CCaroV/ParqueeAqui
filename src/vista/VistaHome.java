...
public class VistaHome extends JFrame {
    ...
    private String nomParqueaderos[] = new String[10];
    ...
    public void setNomParqueaderos(String nomParqueaderos) {
        VistaHome obj = new VistaHome();
        for (String nomParqueadero : obj.nomParqueaderos) {
            System.out.println(nomParqueadero);
        }
    }
